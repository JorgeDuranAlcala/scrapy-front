...
const EmployeeDelete = () => {
  // TO-DO: Pregunta si un empleado puede borrar su cuenta,
  // de ser si la respuesta, pregunta si añades el componente para
  // borrar empleado en la pagina de edit
  ...
  const {control, formState: { errors }, handleSubmit}= useForm({ defaultValues: { checkbox: false } })

  const handleClose = () => setOpen(false)

  const handleSecondDialogClose = () => setSecondDialogOpen(false)

  const onSubmitDelete = () => setOpen(true)
